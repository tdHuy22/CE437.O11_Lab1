...
/* USER CODE END MX_GPIO_Init_1 */
  ...
  HAL_GPIO_WritePin(lebbuiltin_GPIO_Port, lebbuiltin_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, ledred_Pin|ledgreen_Pin|ledblue_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin : lebbuiltin_Pin */
  GPIO_InitStruct.Pin = lebbuiltin_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(lebbuiltin_GPIO_Port, &GPIO_InitStruct);
